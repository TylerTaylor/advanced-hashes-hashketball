...
#     # location = home/away
#     # team_info = the value of the home/away key
#     team_info.each do |attribute, data|
#       # attribute = :team_name, :colors, :players

#       # TODO: This can be refactored - go straight into the players attr from the start
#       if attribute == :players
#         # in the right key, now loop over the values to get to each player
#         data.each do |name, stats|
#           # name = "Alan Anderson" etc
...
#       # attribute = :team_name, :colors, :players
#       if attribute == :players
#         # in the right key, loop over the values to get each player
#         data.each do |name, stats|
#           if name.to_s == player_name
#             return stats[:shoe]
#           end
